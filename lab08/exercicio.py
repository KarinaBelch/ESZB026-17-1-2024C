...
botao3 = QtGui.QPushButton('Medições')
proxy3.setWidget(botao3)
botao3.clicked.connect(medicao_arduino)

proxy4 = QtGui.QGraphicsProxyWidget()
botao4 = QtGui.QPushButton('Aumenta a taxa de Aquisição')
proxy4.setWidget(botao4)
botao4.clicked.connect(aumenta_aquisicao)

proxy5 = QtGui.QGraphicsProxyWidget()
botao5 = QtGui.QPushButton('Diminui a taxa de Aquisição')
proxy5.setWidget(botao5)
botao5.clicked.connect(diminui_aquisicao)
